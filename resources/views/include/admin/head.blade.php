...
<link rel="stylesheet" type="text/css" href="{{ asset('src/admin/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('src/admin/plugins/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('src/admin/plugins/dropzone/dist/min/dropzone.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('src/admin/plugins/gritter/css/jquery.gritter.css') }}">
