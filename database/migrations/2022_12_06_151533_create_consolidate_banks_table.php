...
class CreateConsolidateBanksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consolidate_banks', function (Blueprint $table) {
            ...
            $table->foreign('transference_id')->references('id')->on('transference_banks');
    ...
    {
        Schema::dropIfExists('consolidate_banks');
    }
}
