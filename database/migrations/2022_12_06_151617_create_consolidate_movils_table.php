...
class CreateConsolidateMovilsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('consolidate_movils', function (Blueprint $table) {
            ...
            $table->foreign('transference_id')->references('id')->on('transference_movils');
    ...
    {
        Schema::dropIfExists('consolidate_movils');
    }
}
